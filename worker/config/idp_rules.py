IdpRules = {
    ...
    "PASSKEY": {
        "keywords": ["passkey", "webauthn", "biometric sign in", "sign in with passkey", "sign in with a passkey", 
                    "use a passkey", "create a passkey", "register a passkey", "add a passkey", "face id", "touch id", 
                    "fingerprint", "security key", "no password", "passwordless"],
        "logos": "passkey/",
        "login_request_rule": {
            "domain": ".*",
            "path": ".*",
