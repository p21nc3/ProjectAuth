IdpRules = {
    ...
    "USERNAME_PASSWORD": {
        "keywords": ["sign in", "log in", "username", "password", "login", "signin", "email", "login with email", "continue with email", "enter password"],
        "logos": "basic-auth/",
        "login_request_rule": {
            "domain": ".*",
            "path": ".*",
        ...
        "form_rule": {
            "fields": {
                "username": ["email", "user", "login", "username", "emailaddress"],
    ...
    "PASSKEY": {
        "keywords": ["passkey", "webauthn", "security key", "fingerprint", "biometric", "face id", "touch id"],
        "logos": "passkey/",
        "login_request_rule": {
            "domain": ".*",
            "path": ".*",
    ...
    "MFA_GENERIC": {
        ...
        "mfa_step": {
            "selectors": [".otp-input", "#verificationCode", "input[name='code']", "input[type='tel']", "input[inputmode='numeric']"]
        },
        "sdks": {
            "CUSTOM": {
                "login_request_rule": {
